...
String location = System.getProperty("user.dir")+"/downloads/";	
		...
		//chromedriver
		HashMap<String, Object> prefernces = new HashMap<String, Object>();
		prefernces.put("plugins.always_open_pdf_externally", true);
...
//		profile.setPreference("pdfjs.disbaled",true );
